<!-- Navigation -->
<nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto" x-cloak>
    ...
    <div class="pt-6 mt-6 border-t border-nord4 dark:border-nord2">
        <h3 class="px-3 text-xs font-semibold text-nord3 dark:text-nord4 uppercase tracking-wider mb-3">
            Administration
        </h3>
        ...
        @if(Route::has('credentials.index'))
