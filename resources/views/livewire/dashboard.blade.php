        ...
        <div class="bg-nord5 dark:bg-nord1 rounded-xl border border-nord4 dark:border-nord2 overflow-hidden transition-colors duration-200">
            ...
            <div class="p-6 space-y-3">
                <a href="{{ route('agents.create') }}" wire:navigate class="flex items-center justify-between p-4 rounded-lg border border-nord4 dark:border-nord2 hover:bg-nord4 dark:hover:bg-nord2 transition-all duration-200 group">
                    ...
                    <svg class="w-5 h-5 text-nord3 dark:text-nord4 group-hover:text-primary transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('chat.index') }}" wire:navigate class="flex items-center justify-between p-4 rounded-lg border border-nord4 dark:border-nord2 hover:bg-nord4 dark:hover:bg-nord2 transition-all duration-200 group">
                    <div class="flex items-center space-x-3">
                        <div class="w-10 h-10 bg-primary/20 rounded-lg flex items-center justify-center">
                            <svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
