...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'io.devoption.katra'),
     ...
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'DevOption'),

    /**
     * The copyright notice for your application.
     */
    'copyright' => env('NATIVEPHP_APP_COPYRIGHT', 'Copyright DevOption'),

    /**
     * The description of your application.
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Katra is an open source, graph-native AI workspace for conversations, tasks, and collaborative intelligence.'),

    /**
     * The Website of your application.
     */
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://github.com/devoption/katra'),
